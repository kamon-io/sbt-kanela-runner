...
// https://github.com/playframework/playframework/blob/3.0.1/dev-mode/sbt-plugin/src/main/scala/sbt/PlayRun.scala
...
object KanelaPlayRun {
  ...
  def playRunTask(
    ...
    lazy val devModeServer = play.runsupport.KanelaReloader.startDevMode(
      runHooks.value,
