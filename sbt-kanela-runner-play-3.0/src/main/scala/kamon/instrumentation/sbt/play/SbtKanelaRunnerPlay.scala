...
object SbtKanelaRunnerPlay extends AutoPlugin {
  ...
  override def requires = PlayWeb && SbtKanelaRunner && JavaAgent

  override def projectSettings: Seq[Setting[_]] = Seq(
    Compile / Keys.run := KanelaPlayRun.playDefaultRunTask.evaluated,
    Compile / Keys.bgRun := KanelaPlayRun.playDefaultBgRunTask.evaluated,
